...
//    } ;
    ...
    SimplexEq.simplex = function (f, x0, bounds, radius, xtol, ftol, maxiter, update_handler, abort_test) {
        ...
        return {
			parArr:sim/*[sim[0], fsim[0]]*/,
			iter:iterations,
		};
    };


    /*var x0 = [99,990,9999,10000,-99,-9999,-99999,999999999,9999999999];
     //var x0 = [0.5];
     //    var x0= [0.5,0.4];
     console.log("Nelder-Mead Simplex");
     console.log("===================");
     var start = new Date().getTime() / 1000;
     var x = SimplexEq.simplex(rosen,x0);
     console.log(x);
