    ...
    $.jqplot.BezierCurveRenderer.prototype.setGridData = function(plot) {
        ...
        if (data.length == 2) {
            if (idx == 0) {
                ...
                var webfit = plot.series[idx-1].data;
                this.gridData = [
                    [xp.call(this._xaxis, data[0][0]), yp.call(this._yaxis, data[0][1])], 
                    [xp.call(this._xaxis, data[1][0]), yp.call(this._yaxis, data[1][1]), 
                        xp.call(this._xaxis, data[1][2]), yp.call(this._yaxis, data[1][3]),  
                        xp.call(this._xaxis, data[1][4]), yp.call(this._yaxis, data[1][5])],
                    [xp.call(this._xaxis, webfit[1][4]), yp.call(this._yaxis, webfit[1][5])],
                    [xp.call(this._xaxis, webfit[1][2]), yp.call(this._yaxis, webfit[1][3]),
                        xp.call(this._xaxis, webfit[1][0]), yp.call(this._yaxis, webfit[1][1]),
                        xp.call(this._xaxis, webfit[0][0]), yp.call(this._yaxis, webfit[0][1])]
                ];
            }
        }
        else {
            if (idx == 0) {
                ...
                this.gridData = [
                    ...
                    [xp.call(this._xaxis, data[1][0]), yp.call(this._yaxis, data[1][1]), 
                        xp.call(this._xaxis, data[2][0]), yp.call(this._yaxis, data[2][1]),  
                        xp.call(this._xaxis, data[3][0]), yp.call(this._yaxis, data[3][1])],
                    [xp.call(this._xaxis, webfit[3][0]), yp.call(this._yaxis, webfit[3][1])],
                    [xp.call(this._xaxis, webfit[2][0]), yp.call(this._yaxis, webfit[2][1]),
                        xp.call(this._xaxis, webfit[1][0]), yp.call(this._yaxis, webfit[1][1]),
                        xp.call(this._xaxis, webfit[0][0]), yp.call(this._yaxis, webfit[0][1])]
                ];
            }
