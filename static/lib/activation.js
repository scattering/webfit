...
Ext.onReady(function () {
    ...
    Ext.namespace("activationCalculator");
   ...
   // var store = Ext.create('Ext.data.Store', { model:'deviceModel', data: myData});
    ...
    activationCalculator.a3FieldSet = {
        itemId      : 'a3FieldSet',
        xtype       : 'fieldset',
        border      : false,
    ...
    activationCalculator.a4FieldSet = {
        xtype       : 'fieldset',
        border      : false,
        itemId      : 'a4FieldSet',
        defaultType : 'numberfield',
...
//    activationCalculator.RangePanel = {
//        xtype       : 'form',
//        border      : false,
//        title: 'scanRange',
//        itemId: 'scanRange',
...
//            type:'anchor'
//        },
//        items: [activationCalculator.a3FieldSet,activationCalculator.a4FieldSet]
//    }


    activationCalculator.a3RangePanel = Ext.create('Ext.form.Panel', {
        title: 'A3 range',
    ...
    activationCalculator.a4RangePanel = Ext.create('Ext.form.Panel', {
        title: 'A4 range',
        labelWidth: 75, // label settings here cascade unless overridden
        url: 'save-form.php',
        frame: true,
        ...
        items:[activationCalculator.a4FieldSet]//, activationCalculator.a4FieldSet]
    });



    activationCalculator.TopPanel = Ext.create('Ext.form.Panel', {
        title: 'scanRanges',
        labelWidth: 75, // label settings here cascade unless overridden
        url: '/calculate/',
        frame: true,
...
//        items: [activationCalculator.a3RangePanel,
//        {
//            xtype: 'panel',
...
//            flex: 4
//        }]
        items:[activationCalculator.a3RangePanel, activationCalculator.a4RangePanel],
        buttons: [{
            text: 'Submit',
            handler: function() {
                ...
                if (form.isValid()) {
                    form.submit({
                        success: function(form, action) {
                            ...
                            activationCalculator.plot.series[0].data=result.series
                            activationCalculator.plot.replot({resetAxes : true});
   ...
   // activationCalculator.TopPanel = new Ext.Panel({
   //     layout: 'table',
   //     width: 1100,
   //     layoutConfig: {
   //         columns: 2
   //     },
   //    items: [activationCalculator.RangePanel]
   //});
...
//                activationCalculator.successFunction(response);
//            }
//        });
    }
    ...
    activationCalculator.plotPanel = Ext.create('Ext.form.Panel', {
        title: 'webfit Panel',
        labelWidth: 75, // label settings here cascade unless overridden
        url: 'save-form.php',
        frame: true,
...
//                });
            ...
            activationCalculator.plot = $.jqplot (this.body.id, [sinPoints], {
                title: 'Scan space',
                series: [ {shadow: false,
                           color: 'red',
...
//                    }]
            ...
            //activationCalculator.plot.series[0].data = [];
    ...
    var myTabs = new Ext.TabPanel({
        ...
        width: 1200,
        height: 800,
        activeItem: 'activationCalculatorTab', //Making the calculator tab selected first
        defaults: {autoScroll:true},
        items: [
            {
                title: 'webfit Planner',
                id: 'activationCalculatorTab',
                iconCls: '/static/img/silk/calculator.png',
                layout: 'hbox',
                items: [activationCalculator.TopPanel, activationCalculator.plotPanel]
            },
            {
                title: 'Help Manual',
                id: 'helpmanualtab',
