...
(function ($) {
    ...
    }; // defines LinearInteractorPlugin
    ...
    $.extend($.jqplot.LinearInteractorPlugin.prototype, {
        init: function (options) {
            ...
            this.linear = new $.jqplot.Linear();
            this.linear.initialize(this, this.p1, this.p2, 4); // creates a line using both plugin points
            // this.linear.bind();
            this.grobs.push( this.p1, this.p2,this.linear); // adds line interactor (PluginPoints, line) to list of interactors on graph
