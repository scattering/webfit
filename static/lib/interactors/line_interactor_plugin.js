(function($){
    ...
    $.extend($.jqplot.LineInteractorPlugin.prototype, {
        init: function(options) {
            ...
            this.pivot = new $.jqplot.PluginPoint(); 
            this.pivot.initialize(this, this.xmin, this.ymin); // creates two plugin points for the line      
            this.p2 = new $.jqplot.PluginPoint(); 
            this.p2.initialize(this, this.xmax, this.ymax);
            
            this.line = new $.jqplot.Linear(); 
            this.line.initialize(this, this.pivot, this.p2, 5); // creates a line using both plugin points
            
            this.grobs.push(this.linear, /*this.pivot,*/ this.p2); // adds line interactor (PluginPoints, line) to list of interactors on graph
